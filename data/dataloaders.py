...
class DataProvider():
    ...
    def __init__(self, musdb_root, musdb_is_wav,
    ...
    def get_train_dataloader(self, n_fft, hop_length, num_frame):
        return get_train_dataloader(self.musdb_root, self.is_wav,
    ...
    def get_valid_dataloader(self, n_fft, hop_length, num_frame):
        return get_valid_dataloader(self.musdb_root, self.is_wav,
                                    n_fft, hop_length, num_frame,
                                    self.batch_size, self.num_workers, self.pin_memory,
                                    self.cache_mode, self.dev_mode)

    def get_test_dataloader(self, n_fft, hop_length, num_frame):
        return get_test_dataloader(self.musdb_root, self.is_wav,
                                   n_fft, hop_length, num_frame,
                                   self.batch_size, self.num_workers, self.pin_memory,
                                   self.cache_mode, self.dev_mode)


def get_train_dataloader(musdb_root, is_wav,
                         n_fft, hop_length, num_frame,
...
def get_valid_dataloader(musdb_root, is_wav,
                         n_fft, hop_length, num_frame,
                         batch_size=4, num_workers=1, pin_memory=True,
                         cache_mode=True, dev_mode=False
                         ) -> DataLoader:
...
def get_test_dataloader(musdb_root, is_wav,
                        n_fft, hop_length, num_frame,
                        batch_size=4, num_workers=1, pin_memory=True,
                        cache_mode=True, dev_mode=False
                        ) -> DataLoader:
